...
nix-shell -p arduino-cli --run \
  "arduino-cli compile --fqbn esp32:esp32:esp32:PartitionScheme=rainmaker --build-property \"build.extra_flags=-DCORE_DEBUG_LEVEL=0\" --libraries /home/tsd/1/code/arduino/libraries -u -p $PORT bcd_clock.ino"
